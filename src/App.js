...
<div className="page">
                ...
                <div className="page__subcontainer">
                    <header className="page__header">
                        <div className="wrapper">
                            <div className="header__logo"> <a href="index.html" className="header__link"><h1 className="header__logo-img">Awesome profile cards</h1></a>
                    ...
                    <main className="main__landing-page">
                        <div className="main__landing">
                            ...
                            <div className="main__landing-start"> <a href="createCard.html" className="main__landing-link">comenzar</a>
            ...
            <footer className="page__footer">
                <div className="wrapper">
                    ...
                    <div className="footer__logo"> <a href="https://adalab.es/" target="_blank"><img className="footer__logo-adalab" src="assets/images/adalab-logo.png" alt="adalab logo"/></a>
