...
const Fill = props => {
  const { updateUser, user:{name,job,email,phone,linkedin,github}, imageLoad, clickLoadImage, getImage, isDefaultImage } = props;
  return (
    <div className="fill__container-form section__collapse">
      ...
      <ImageLoad imageLoad={imageLoad} clickLoadImage={clickLoadImage} getImage={getImage} photo={user.photo} isDefaultImage={isDefaultImage} />
