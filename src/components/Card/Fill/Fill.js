  ...
  return (
    <div className="fill__container-form section__collapse">
      <InputFill 
        ...
        inputId={'name'} 
        inputType={'text'} 
        inputName={'completeName'} 
        inputPlaceholder={'Ej: Sally Jill'} 
        updateUser={updateUser} 
        classError={inputErrorArr.includes('name') ? 'error' : ''} />
      <InputFill 
        valueInput={job} 
        labelFor={'job'} 
        labelContent={'puesto'} 
        ...
        updateUser={updateUser} 
        classError={inputErrorArr.includes('job') ? 'error' : ''} />
      <ImageLoad 
        imageLoad={imageLoad} 
        clickLoadImage={clickLoadImage} 
        getImage={getImage} 
        photo={photo} 
        isDefaultImage={isDefaultImage} 
        classError={inputErrorArr.includes('photo') ? 'error' : ''} />
      <InputFill 
        valueInput={email} 
        labelFor={'email'} 
        labelContent={'email'} 
        ...
        dataInfo={'mailto:'} 
        updateUser={updateUser} 
        classError={inputErrorArr.includes('email') ? 'error' : ''} />
      <InputFill 
        valueInput={phone} 
        labelFor={'phone'} 
      ...
      <InputFill 
        ...
        inputName={'github'} 
        inputPlaceholder={'Ej: sally-hill'} 
        dataInfo={'https://github.com/'} 
        updateUser={updateUser} 
        classError={inputErrorArr.includes('github') ? 'error' : ''} />
    </div>
  );
};
