...
const Fill = props => {
  const { updateUser, user:{name,job,email,phone,linkedin,github} } = props;
  return (
    <div className="fill__container-form section__collapse">
      ...
      <InputFill valueInput={phone}
      labelFor={'phone'} labelContent={'teléfono'} inputId={'phone'} inputType={'tel'} inputName={'phoneNumber'} inputPlaceholder={'Ej: 555-55-55-55'} dataInfo={'tel:'} updateUser={updateUser} />
