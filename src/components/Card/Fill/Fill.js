...
const Fill = props => {
  ...
  return (
    <div className="fill__container-form section__collapse">
      ...
      <InputFill valueInput={linkedin} labelFor={'linkedin'} labelContent={'linkedin'} inputId={'linkedin'} inputType={'text'} inputName={'linkedin'} inputPlaceholder={'Ej: sally.hill'} dataInfo={'https://www.linkedin.com/in/'} updateUser={updateUser} classError={inputErrorArr.includes('linkedin') ? 'error' : ''}/>
